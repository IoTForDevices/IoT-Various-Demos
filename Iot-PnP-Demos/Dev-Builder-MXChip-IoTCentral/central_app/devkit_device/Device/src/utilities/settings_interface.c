...
DIGITALTWIN_INTERFACE_CLIENT_HANDLE SettingsInterface_Create()
{
    ...
    else if ((result = DigitalTwin_InterfaceClient_SetPropertiesUpdatedCallback(interfaceHandle, SettingsInterface_ProcessPropertyUpdate, (void*)&appState)) != DIGITALTWIN_CLIENT_OK)
    {
