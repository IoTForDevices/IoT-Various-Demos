...
bool Environmentalsensor_SerializeTemperatureTelemetry(char * payloadBuffer, int size)
{
    ...
    double temperature = Environmentalsensor_Telemetry_ReadTemperature();
...
bool Environmentalsensor_SerializeHumidityTelemetry(char * payloadBuffer, int size)
{
    ...
    double humidity = Environmentalsensor_Telemetry_ReadHumidity();
...
bool Environmentalsensor_SerializeToggleCommandResponse(char* response, char* payloadBuffer, int size)
{
    ...
    if (neededSize > size - 1)
    {
        LogError("Failed to build toggle response payload string");
        return false;
    }
    else
    {
