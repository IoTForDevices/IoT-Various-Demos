...
*/
int DigitalTwinClientHelper_SetCommandResponse(DIGITALTWIN_CLIENT_COMMAND_RESPONSE* digitalTwinClientCommandResponseContext, const unsigned char* responseData, int status);
...
*/
void DigitalTwinClientHelper_SetUpdateAsyncStatus(DIGITALTWIN_CLIENT_ASYNC_COMMAND_UPDATE *digitalTwinClientAsyncCommandUpdate, const char* commandName, const char* requestId, const unsigned char* propertyData, int statusCode);
