...
// DeviceinfoInterface_ReportPropertyAsync is a helper function to report a Deviceinfo's properties.
// It invokes underlying DigitalTwin API for reporting properties and sets up its callback on completion.
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_ReportPropertyAsync(DIGITALTWIN_INTERFACE_CLIENT_HANDLE interfaceHandle, const char* propertyName, const char* propertyData)
{
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportManufacturer()
{
    ...
    if (Deviceinfo_SerializeManufacturerProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_ManufacturerProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportModel()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeModelProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_ModelProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportSwVersion()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeSwVersionProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_SwVersionProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportOsName()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeOsNameProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_OsNameProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportProcessorArchitecture()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeProcessorArchitectureProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_ProcessorArchitectureProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportProcessorManufacturer()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeProcessorManufacturerProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_ProcessorManufacturerProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportTotalStorage()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeTotalStorageProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_TotalStorageProperty, payloadBuffer);
    }
    else
    {
...
DIGITALTWIN_CLIENT_RESULT DeviceinfoInterface_Property_ReportTotalMemory()
{
    ...
    char payloadBuffer[MAX_MESSAGE_SIZE];
    if (Deviceinfo_SerializeTotalMemoryProperty(payloadBuffer, MAX_MESSAGE_SIZE))
    {
        return DeviceinfoInterface_ReportPropertyAsync(appState.interfaceClientHandle, DeviceinfoInterface_TotalMemoryProperty, payloadBuffer);
    }
    else
    {
